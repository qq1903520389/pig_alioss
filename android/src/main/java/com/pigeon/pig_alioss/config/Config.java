...
//    public static final String OSS_ENDPOINT = "https://oss-cn-beijing.aliyuncs.com/";
    //callback 测试地址http://oss-demo.aliyuncs.com:23450
    ...
    public static final String STS_SERVER_URL = "http://19";//STS 地址

    public static final String BUCKET_NAME = "pigeon-shop-app";
    public static final String OSS_ACCESS_KEY_ID = "LTAI5tPddZhByP";
    public static final String OSS_ACCESS_KEY_SECRET = "hTQfDFUiADS8zjMu48";
