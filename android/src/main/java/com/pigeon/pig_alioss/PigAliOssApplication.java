 ...
 * @program: android
 * @author: 周立强
 * @create: 2023-09-10 09:19
 */
public class PigAliOssApplication implements Thread.UncaughtExceptionHandler  {
    ...
    public static final String TAG = PigAliOssApplication.class.getSimpleName();
    ...
    public static void setBinding(ActivityPluginBinding binding) {
        PigAliOssApplication.binding = binding;
    }

    public static Activity getActivity() {
        return PigAliOssApplication.mActivity;
    }

    public static void setActivity(Activity mActivity) {
        AppUtils.init(mActivity);
        PigAliOssApplication.mActivity = mActivity;
    }
