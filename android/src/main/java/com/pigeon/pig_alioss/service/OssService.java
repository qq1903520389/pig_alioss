...
import com.pigeon.utils.http.JsonUtil;
import com.pigeon.utils.thread.ThreadUtils;
...
public class OssService {
    ...
    public void asyncGetImage(String object,OssServiceI ossServiceI) {
        ...
        get.setProgressListener(new OSSProgressCallback<GetObjectRequest>() {
            ...
            public void onProgress(GetObjectRequest request, long currentSize, long totalSize) {
                ...
                ThreadUtils.setMethod(PigAliOssApplication.getActivity(), new ThreadUtils.ThreadUtil() {
                    @Override
                    public void run(Activity activity) {
                        ossServiceI.onProgress(progress,totalSize,request.getObjectKey());
                    }
                });
        ...
        OSSAsyncTask task = mOss.asyncGetObject(get, new OSSCompletedCallback<GetObjectRequest, GetObjectResult>() {
            ...
            public void onSuccess(GetObjectRequest request, GetObjectResult result) {
                ...
                try {
                    ...
                    final String FILE_DIR = PigAliOssApplication.getActivity().getFilesDir().getAbsolutePath()
                             + File.separator + "oss/";
                    //判断SD卡是否可用
                    if (MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                        File path = new File(FILE_DIR + "app/");
                        File file = new File(FILE_DIR + object);
                        if (!path.exists()) {
                        ...
                        FileUtil.writeFile(FILE_DIR + object, inputStream);
...
//                        logFilePath = context.getFilesDir() + File.separator + dir;
                    ...
                    try {
                        jsonObject.put("objectKey",request.getObjectKey());
                        jsonObject.put("filePath",FILE_DIR + object);
                    ...
                    ThreadUtils.setMethod(PigAliOssApplication.getActivity(), new ThreadUtils.ThreadUtil() {
                        @Override
                        public void run(Activity activity) {
                            ossServiceI.onSuccess(jsonObject);
                        }
                    });

                    mDisplayer.downloadComplete(FILE_DIR + object);
            ...
            public void onFailure(GetObjectRequest request, ClientException clientExcepion, ServiceException serviceException) {
                ...
                ThreadUtils.setMethod(PigAliOssApplication.getActivity(), new ThreadUtils.ThreadUtil() {
                    @Override
                    public void run(Activity activity) {
                        ossServiceI.onFailure(serviceException);
                    }
                });
    ...
    public void asyncPutImage(String object, String localFile,OssServiceI ossServiceI) {
        ...
        OSSAsyncTask task = mOss.asyncPutObject(put, new OSSCompletedCallback<PutObjectRequest, PutObjectResult>() {
            ...
            public void onSuccess(PutObjectRequest request, PutObjectResult result) {
                ...
                try {
                    ...
                    jsonObject.put("objectKey",request.getObjectKey());
                    jsonObject.put("Bucket",mBucket);
                    jsonObject.put("RequestId",result.getRequestId());
                    jsonObject.put("Callback",result.getServerCallbackReturnBody());
                    jsonObject.put("ETag",result.getETag());
                } catch (JSONException e) {
                    throw new RuntimeException(e);
                }
                ThreadUtils.setMethod(PigAliOssApplication.getActivity(), new ThreadUtils.ThreadUtil() {
                ...
                mDisplayer.uploadComplete(request.getObjectKey());
                mDisplayer.displayInfo("Bucket: " + mBucket
                        + "\nObject: " + request.getObjectKey()
                        + "\nETag: " + result.getETag()
                        + "\nRequestId: " + result.getRequestId()
...
//                mDisplayer.displayInfo(result.getServerCallbackReturnBody());
    ...
    public interface  OssServiceI{
        void onProgress(int progress,long totalSize,String objectKey);
